...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/berita2.css') }}">
</head>
<body>
    <header>
        <div class="top-bar">
    ...
    <section class="berita-content">
        <div class="text-section">
            <h1>Penanaman Pohon Bersama PT. BETTS Indonesia di Desa Kedungudi dalam Memperingati World Environment Day</h1>
            <h2>Rabu, 17 Juli 2024</h2>
        </div>
        <img src="img/berita2.jpeg" alt="Berita Image">
        <div class="berita-summary">
            ...
            <p>Acara ini merupakan kerja sama antara berbagai pihak, termasuk PT BETTS Indonesia, RT, RW, Karang Taruna, BUMDes, perangkat desa, dan mahasiswa KKN. PT BETTS Indonesia berperan sebagai penyedia bibit pohon untuk acara ini, dengan jenis pohon yang ditanam meliputi alpukat, durian, rambutan, dan jambu crystal.</p>
            <p>Kegiatan ini bertujuan untuk meningkatkan kesadaran masyarakat akan pentingnya menjaga lingkungan serta memberikan kontribusi nyata dalam pelestarian alam.</p>
        </div>
    </section>
