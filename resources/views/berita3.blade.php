...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/berita3.css') }}">
</head>
<body>
    <header>
        <div class="top-bar">
    ...
    <section class="berita-content">
        <div class="text-section">
            <h1>Pelatihan Excel untuk Pembukuan Keuangan Unit Usaha BUMDes Adhinata Mandiri Kedungudi</h1>
            <h2>Minggu, 29 Juni 2024</h2>
        </div>
        <img src="img/berita3.jpeg" alt="Berita Image">
        <div class="berita-summary">
            ...
            <p>Dalam pelatihan ini, peserta akan belajar cara menginput data pemasukan dan pengeluaran menggunakan format Excel. Ini termasuk cara membuat tabel untuk mencatat transaksi keuangan, mengelompokkan jenis transaksi, menggunakan formula untuk menghitung total, dan membuat laporan keuangan bulanan. Peserta juga akan diajarkan cara menyusun laporan keuangan sederhana dan cara memanfaatkan fitur-fitur Excel seperti grafik dan pivot table untuk analisis data keuangan.</p>
        </div>
    </section>
