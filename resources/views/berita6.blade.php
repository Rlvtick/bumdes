...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/berita6.css') }}">
</head>
<body>
    <header>
        <div class="top-bar">
    ...
    <section class="berita-content">
        <div class="text-section">
            <h1>Laporan Bulanan dan Koordinasi Pengembangan antara Unit, BUMDes, dan Pemerintah Desa</h1>
            <h2>Rabu, 10 April 2024</h2>
        </div>
        <img src="img/berita6.jpeg" alt="Berita Image">
        <div class="berita-summary">
            ...
            <p>Laporan dari masing-masing unit usaha akan disampaikan ke BUMDes, kemudian diteruskan ke Pemerintah Desa untuk evaluasi dan koordinasi. Selain itu, akan dibahas juga pengembangan lebih lanjut untuk setiap unit usaha. Tujuan dari pertemuan ini adalah untuk memastikan transparansi, akuntabilitas, dan perencanaan strategis dalam pengelolaan unit-unit usaha desa.</p>
        </div>
    </section>
